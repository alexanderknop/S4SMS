...
"uniform/sparse_1.62_stack_sort.dat" using 1:2 title '1.62-stack sort' with lines,\
"uniform/sparse_1.62_merge_sort.dat" using 1:2 title '1.62-merge sort' with lines
...
"power/sparse_1.62_stack_sort.dat" using 1:2 title '1.62-stack sort' with lines,\
"power/sparse_1.62_merge_sort.dat" using 1:2 title '1.62-merge sort' with lines
